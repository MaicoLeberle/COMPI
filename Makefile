...
$(TARGET): $(MAIN) $(SEMANTIC_ANALYSIS) $(SYMTABLE) $(INTERMEDIATE_SYMTABLE) $(LEXER) $(PARSER) $(INTER_CODE_GEN_VISITOR) $(THREE_ADDRESS_CODE)
	$(CC) -o$(TARGET) $(MAIN) $(SEMANTIC_ANALYSIS) $(INTER_CODE_GEN_VISITOR) $(THREE_ADDRESS_CODE) $(INTERMEDIATE_SYMTABLE) $(SYMTABLE) $(LEXER) $(PARSER) $(LDFLAGS) $(CPPFLAGS) $(LINKERFLAGS)

$(TEST_SUITE): $(TEST_MAIN) $(SEMANTIC_ANALYSIS) $(SYMTABLE) $(INTERMEDIATE_SYMTABLE) $(LEXER) $(PARSER) $(TEST_INTER_CODE_GEN_VISITOR)
	$(CC) -o$(TEST_SUITE) $(TEST_MAIN) $(SEMANTIC_ANALYSIS) $(INTER_CODE_GEN_VISITOR) $(THREE_ADDRESS_CODE) $(INTERMEDIATE_SYMTABLE) $(SYMTABLE) $(TEST_INTER_CODE_GEN_VISITOR) $(LEXER) $(PARSER) $(LDFLAGS) $(CPPFLAGS) $(LINKERFLAGS)
